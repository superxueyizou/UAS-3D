...
public class MDPValueIteration
{
	...
	{	
		...
		try 
        {
            indexFileWriter = new FileWriter("src/saa/collsionavoidance/acasx3d/generatedFiles/indexFile",false);
            costFileWriter = new FileWriter("src/saa/collsionavoidance/acasx3d/generatedFiles/costFile",false);
